        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('users.create') }}" role="button" class="btn btn-primary btn-sm btn-flat">
                        Добавить
                    </a>
                    @if (request()->has('q'))
                        <a href="{{ route('users.index') }}" role="button" class="btn btn-danger btn-sm btn-flat" title="Сбросить фильтр">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        @if ($paginator->isNotEmpty())
                            @foreach ($paginator as $value)
                                @include('admin.users.components.tr_index', [$value])
                            @endforeach
                        @endif
                        </tbody>
                    </table>
