        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('tags.create') }}" role="button" class="btn btn-primary btn-sm btn-flat">
                        Добавить
                    </a>
                    @if (request()->has('q'))
                        <a href="{{ route('tags.index') }}" role="button" class="btn btn-danger btn-sm btn-flat" title="Сбросить фильтр">
