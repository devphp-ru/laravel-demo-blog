<div class="mb-3">
    ...
    <input id="username" name="username" value="{{ old('username')?? $item->username  ?? '' }}" type="text" class="form-control @if (isset($errors)) @error('username') is-invalid @enderror @endif" autocomplete="off">
    @if (isset($errors))
        @error('username')
