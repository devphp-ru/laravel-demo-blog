# Демонстрационный проект на Laravel 10

Демонстрационный проект для тренировки навыков разработки, использую разные решения и подходы для оттачивания скиллов.
